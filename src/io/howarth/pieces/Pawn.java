...
public class Pawn extends Piece {
	...
	private ArrayList<Move> whitePawn() {
		...
		if(!getBoard().outOfRange(x, j)&&getBoard().occupied(x, j)
				&&(getBoard().getPiece(x, j).getColour()!=this.getColour())){
			m = new Move(this, x,y,x,j,true);
			v.add(m);
		}	
		...
		if(!getBoard().outOfRange(k, y)&&getBoard().occupied(k, y)
				&&(getBoard().getPiece(k, y).getColour()!=this.getColour())){
			m = new Move(this, x,y,k,y,true);
			v.add(m);
		}	 
		...
		if(!getBoard().outOfRange(l, y)&&getBoard().occupied(l, y)
				&&(getBoard().getPiece(l, y).getColour()!=this.getColour())){
			m = new Move(this, x,y,l,y,true);
			v.add(m);
		}

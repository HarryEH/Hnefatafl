...
public final class TextHandler {
    ...
    public ImageIcon convert(char ch) {
        ...
        switch (ch) {
            case 'p':
                icon = new ImageIcon(getClass().getResource("icons/Chess_plt60.png"));
                break;
            case 'P':
                icon = new ImageIcon(getClass().getResource("icons/Chess_pdt60.png"));
                break;
            case 'k':
                icon = new ImageIcon(getClass().getResource("icons/Chess_klt60.png"));
                break;
        }
        return icon;
    }
